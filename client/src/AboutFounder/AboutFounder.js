  ...
  <>
    ...
    <div className='container-fluid abtparts'>
        ...
        <h1 className='subhead2 text-center py-2'>About Us</h1>
            ...
            <p className='textjust textst medsafepara'><span className='subhead7'>Oviya MedSafe </span>provides comprehensive, end-to-end global Drug Safety support, including regulatory-compliant Drug Safety database access when required, to pharma/biotech manufacturers with established Pharmacovigilance systems. Additionally, Oviya MedSafe specializes in providing tailored consulting to emerging innovator companies and generic regulatory approval holders worldwide, helping them continuously enhance their Pharmacovigilance departments and ensure compliance with market-specific regulatory requirements.</p>
            </div>
