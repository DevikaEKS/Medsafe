    ...
    <div className='container py-5'>
      <div className='row'>
        <div className='col-sm-12 col-md-5 col-lg-5'>
          <h3 className='abttxt'>About Us <BsArrowUpRightCircle className="arrowic cursor-pointer  d-md-none" onClick={()=>nav("/about-us")}/></h3>
          <h1 className='subhead2 text-start pb-2'>Oviya MedSafe <BsArrowUpRightCircle className="arrowic cursor-pointer d-none d-md-inline-block" onClick={()=>nav("/about-us")}/></h1>
